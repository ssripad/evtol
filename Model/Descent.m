...
DescentOutput.startPower   	=   W_TO.*-VD./1000 + ...
                                (1/2).*Dc.*DescentOutput.startVelocity.^3.*S.*cd0./1000./Ncli + ...
                                ( (K*W_TO.^2) ./ ((1/2).*Dc.*DescentOutput.startVelocity.*S) )./1000./Ncli; % Kw 
DescentOutput.endPower     	=  	W_TO.*-VD./1000 + ...
                                (1/2).*Dc.*DescentOutput.startVelocity.^3.*S.*cd0./1000./Ncli + ...
                                ( (K*W_TO.^2) ./ ((1/2).*Dc.*DescentOutput.startVelocity.*S) )./1000./Ncli; % Kw 
